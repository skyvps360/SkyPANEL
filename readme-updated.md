...
- **Professional Invoicing**: Automated PDF invoice generation with branding
...
POST   /api/invoices/generate-missing      # Generate missing invoices for existing transactions
```
...
The system automatically generates professional PDF invoices:

#### Features
- **Professional Formatting**: Clean, branded invoice design
...
- **Download Options**: PDF download for users and administrators

#### Customization
```javascript
// Dynamic company branding in invoices
